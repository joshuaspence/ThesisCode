...
add_file ../../source/distance.cpp -cflags " -I../../include  -I../../include/autoesl -D__AUTOESL__ -DINSERT=SORTED -DBLOCKING=ENABLED -DUSE_DYNAMIC_ARRAY_SIZE=DISABLED -DTEST_TYPE=EMBEDDED -DTOP__DISTANCE_SQUARED"
add_file -tb ../../source/parameters.cpp -cflags " -I../../include  -I../../include/autoesl -D__AUTOESL__ -DINSERT=SORTED -DBLOCKING=ENABLED -DUSE_DYNAMIC_ARRAY_SIZE=DISABLED -DTEST_TYPE=EMBEDDED -DTOP__DISTANCE_SQUARED"
