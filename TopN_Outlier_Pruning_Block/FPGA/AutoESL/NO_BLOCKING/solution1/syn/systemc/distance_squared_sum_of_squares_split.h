...
#ifndef _distance_squared_sum_of_squares_split_H_
#define _distance_squared_sum_of_squares_split_H_
...
struct distance_squared_sum_of_squares_split_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(distance_squared_sum_of_squares_split_core);
    distance_squared_sum_of_squares_split_core(sc_core::sc_module_name) {
        SC_METHOD(proc_di);
        sensitive << d;
...
SC_MODULE( distance_squared_sum_of_squares_split )
{
    ...
    SC_CTOR( distance_squared_sum_of_squares_split ) {
        meminst = new distance_squared_sum_of_squares_split_core <1, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    distance_squared_sum_of_squares_split_core <1, 2, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_distance_squared_sum_of_squares_split_H_
