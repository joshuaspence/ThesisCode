...
#ifndef __distance_squared_grp_fu_232_ACMP_dcmp_4__HH__
#define __distance_squared_grp_fu_232_ACMP_dcmp_4__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distance_squared_grp_fu_232_ACMP_dcmp_4) {
    ...
    SC_CTOR(distance_squared_grp_fu_232_ACMP_dcmp_4):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
