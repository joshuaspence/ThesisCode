...
#----------------------------------------------------------------------------
proc extract_area {file_name file_name1} {
    ...
    set return_value [list $slice_count $lut_count $ff_count $mult_count $bram_count $latch_count]
    return $return_value
}
...
proc dump_report_synxil { module out } {
    ...
    set area_results [extract_area ${module}_usage.xml ${module}.par]
    puts $out ""
    puts $out ""
    ...
    set t1 [format "%2.3f" [extract_timing ${module}.twr]]
...
proc dump_report_xml { module out } {
    ...
    set achievedcp [format "%.3f" [extract_timing ${module}.twr]]
    # dump xml
    puts $out "<profile>"
    puts $out ""
    puts $out "<AreaReport>"
...
proc report_copy { module dir} {
    ...
    if {[file exists $filename]} {
        if {[file isdirectory $dir]} {
            file copy -force $filename $dir/${module}.rpt
...
proc xmlreport_copy {module dir} {
    ...
    if {[file exists $filename]} {
        if {[file isdirectory $dir]} {
            file copy -force $filename $dir/${module}.xml
