...
set ID 7
set MemName distance_squared_sum_of_squares_split
...
set portmap { vector1_data_V TDATA vector1_keep_V TKEEP vector1_last_V TLAST vector1_strb_V TSTRB vector1_tdest_V TDEST vector1_user_V TUSER vector1_data_V TDATA vector1_keep_V TKEEP vector1_last_V TLAST vector1_strb_V TSTRB vector1_tdest_V TDEST vector1_user_V TUSER vector1_data_V TDATA vector1_keep_V TKEEP vector1_last_V TLAST vector1_strb_V TSTRB vector1_tdest_V TDEST vector1_user_V TUSER }
set metadata { -bus_bundle INPUT_STREAM_A}
if {${::AESL::PGuard_autoexp_gen}} {
...
set portmap { vector2_data_V TDATA vector2_keep_V TKEEP vector2_last_V TLAST vector2_strb_V TSTRB vector2_tdest_V TDEST vector2_user_V TUSER vector2_data_V TDATA vector2_keep_V TKEEP vector2_last_V TLAST vector2_strb_V TSTRB vector2_tdest_V TDEST vector2_user_V TUSER vector2_data_V TDATA vector2_keep_V TKEEP vector2_last_V TLAST vector2_strb_V TSTRB vector2_tdest_V TDEST vector2_user_V TUSER }
set metadata { -bus_bundle INPUT_STREAM_B}
if {${::AESL::PGuard_autoexp_gen}} {
if {[info proc ::AESL_LIB_XILADAPTER::axis_gen] == "::AESL_LIB_XILADAPTER::axis_gen"} {
eval "::AESL_LIB_XILADAPTER::axis_gen { \
    corename ${corename} \
