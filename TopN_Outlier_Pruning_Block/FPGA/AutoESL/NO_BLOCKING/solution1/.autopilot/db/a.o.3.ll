; ModuleID = 'D:/Josh/ThesisCode/TopN_Outlier_Pruning_Block/FPGA/AutoESL/NO_BLOCKING/solution1/.autopilot/db/a.o.3.bc'
...
@p_str15 = private constant [11 x i8] c"ap_ctrl_hs\00", align 1 ; <[11 x i8]*> [#uses=1]
@p_str16 = private constant [1 x i8] zeroinitializer, align 1 ; <[1 x i8]*> [#uses=28]
@p_str17 = private constant [13 x i8] c"aesl_label_0\00", align 1 ; <[13 x i8]*> [#uses=2]
@p_str18 = private constant [8 x i8] c"ap_none\00", align 1 ; <[8 x i8]*> [#uses=1]
@p_str19 = private constant [13 x i8] c"aesl_label_1\00", align 1 ; <[13 x i8]*> [#uses=2]
@p_str20 = private constant [10 x i8] c"AXI_SLAVE\00", align 1 ; <[10 x i8]*> [#uses=2]
@p_str21 = private constant [66 x i8] c"{ap_start START} {ap_done DONE} {ap_idle IDLE} {ap_return RETURN}\00", align 4 ; <[66 x i8]*> [#uses=1]
@p_str22 = private constant [24 x i8] c"-bus_bundle CONTROL_BUS\00", align 1 ; <[24 x i8]*> [#uses=2]
@p_str23 = private constant [13 x i8] c"aesl_label_2\00", align 1 ; <[13 x i8]*> [#uses=2]
@p_str24 = private constant [13 x i8] c"aesl_label_4\00", align 1 ; <[13 x i8]*> [#uses=2]
@p_str25 = private constant [13 x i8] c"aesl_label_3\00", align 1 ; <[13 x i8]*> [#uses=2]
...
@p_str28 = private constant [27 x i8] c"-bus_bundle INPUT_STREAM_A\00", align 1 ; <[27 x i8]*> [#uses=1]
@p_str29 = private constant [139 x i8] c"{vector1_keep_V TKEEP} {vector1_data_V TDATA} {vector1_strb_V TSTRB} {vector1_user_V TUSER} {vector1_last_V TLAST} {vector1_tdest_V TDEST}\00", align 4 ; <[139 x i8]*> [#uses=1]
@p_str30 = private constant [13 x i8] c"aesl_label_6\00", align 1 ; <[13 x i8]*> [#uses=2]
@p_str31 = private constant [13 x i8] c"aesl_label_5\00", align 1 ; <[13 x i8]*> [#uses=2]
@p_str32 = private constant [27 x i8] c"-bus_bundle INPUT_STREAM_B\00", align 1 ; <[27 x i8]*> [#uses=1]
@p_str33 = private constant [139 x i8] c"{vector2_keep_V TKEEP} {vector2_data_V TDATA} {vector2_strb_V TSTRB} {vector2_user_V TUSER} {vector2_last_V TLAST} {vector2_tdest_V TDEST}\00", align 4 ; <[139 x i8]*> [#uses=1]
@p_str34 = private constant [15 x i8] c"dimension_loop\00", align 1 ; <[15 x i8]*> [#uses=3]
...
entry:
  ...
  call void @llvm.dbg.value(metadata !{i8* %vector1_keep_V}, i64 0, metadata !906)
  call void @llvm.dbg.value(metadata !{i1* %vector1_last_V}, i64 0, metadata !918)
  call void @llvm.dbg.value(metadata !{i64* %vector2_data_V}, i64 0, metadata !930)
  call void @llvm.dbg.value(metadata !{i8* %vector2_keep_V}, i64 0, metadata !932)
  call void @llvm.dbg.value(metadata !{i1* %vector2_last_V}, i64 0, metadata !933)
  call void @llvm.dbg.value(metadata !{double* %sum}, i64 0, metadata !934)
  call void @llvm.dbg.declare(metadata !{[8 x double]* %sum_of_squares_split}, metadata !936), !dbg !942
  call void (...)* @_ssdm_op_SpecWire(i32 0, [11 x i8]* @p_str15, [1 x i8]* @p_str16) nounwind, !dbg !943
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str17) nounwind, !dbg !944 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecWire(double* %sum, [8 x i8]* @p_str18, [1 x i8]* @p_str16) nounwind, !dbg !944
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str17, i32 %tmp_2) nounwind, !dbg !944 ; <i32> [#uses=0]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str19) nounwind, !dbg !945 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @p_str16, [10 x i8]* @p_str20, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [66 x i8]* @p_str21, [24 x i8]* @p_str22) nounwind, !dbg !945
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str19, i32 %tmp_3) nounwind, !dbg !945 ; <i32> [#uses=0]
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str23) nounwind, !dbg !946 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecIFCore(double* %sum, [1 x i8]* @p_str16, [10 x i8]* @p_str20, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [24 x i8]* @p_str22) nounwind, !dbg !946
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str23, i32 %tmp_4) nounwind, !dbg !946 ; <i32> [#uses=0]
  %tmp_5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str24) nounwind, !dbg !947 ; <i32> [#uses=1]
  %tmp_6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str25) nounwind, !dbg !947 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecFifo(i64* %vector1_data_V, i8* %vector1_keep_V, i1* %vector1_last_V, [8 x i8]* @p_str26, [1 x i8]* @p_str16), !dbg !947
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str25, i32 %tmp_6) nounwind, !dbg !947 ; <i32> [#uses=0]
  call void (...)* @_ssdm_op_SpecIFCore(i64* %vector1_data_V, i8* %vector1_keep_V, i1* %vector1_last_V, [1 x i8]* @p_str16, [5 x i8]* @p_str27, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [27 x i8]* @p_str28) nounwind, !dbg !947
  call void (...)* @_ssdm_op_SpecIFCore(i64* %vector1_data_V, i8* %vector1_keep_V, i1* %vector1_last_V, [1 x i8]* @p_str16, [5 x i8]* @p_str27, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [139 x i8]* @p_str29, [1 x i8]* @p_str16) nounwind, !dbg !947
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str24, i32 %tmp_5) nounwind, !dbg !947 ; <i32> [#uses=0]
  %tmp_7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str30) nounwind, !dbg !948 ; <i32> [#uses=1]
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str31) nounwind, !dbg !948 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecFifo(i64* %vector2_data_V, i8* %vector2_keep_V, i1* %vector2_last_V, [8 x i8]* @p_str26, [1 x i8]* @p_str16), !dbg !948
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str31, i32 %tmp_8) nounwind, !dbg !948 ; <i32> [#uses=0]
  call void (...)* @_ssdm_op_SpecIFCore(i64* %vector2_data_V, i8* %vector2_keep_V, i1* %vector2_last_V, [1 x i8]* @p_str16, [5 x i8]* @p_str27, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [27 x i8]* @p_str32) nounwind, !dbg !948
  call void (...)* @_ssdm_op_SpecIFCore(i64* %vector2_data_V, i8* %vector2_keep_V, i1* %vector2_last_V, [1 x i8]* @p_str16, [5 x i8]* @p_str27, [1 x i8]* @p_str16, [1 x i8]* @p_str16, [139 x i8]* @p_str33, [1 x i8]* @p_str16) nounwind, !dbg !948
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str30, i32 %tmp_7) nounwind, !dbg !948 ; <i32> [#uses=0]
  %sum_of_squares_split_addr = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 0, !dbg !949 ; <double*> [#uses=2]
  store double 0.000000e+000, double* %sum_of_squares_split_addr, align 8, !dbg !949
  %sum_of_squares_split_addr_1 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 1, !dbg !949 ; <double*> [#uses=2]
  store double 0.000000e+000, double* %sum_of_squares_split_addr_1, align 8, !dbg !949
  %sum_of_squares_split_addr_2 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 2, !dbg !949 ; <double*> [#uses=2]
  store double 0.000000e+000, double* %sum_of_squares_split_addr_2, align 8, !dbg !949
  %sum_of_squares_split_addr_3 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 3, !dbg !949 ; <double*> [#uses=2]
  store double 0.000000e+000, double* %sum_of_squares_split_addr_3, align 8, !dbg !949
  %sum_of_squares_split_addr_4 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 4, !dbg !949 ; <double*> [#uses=2]
  store double 0.000000e+000, double* %sum_of_squares_split_addr_4, align 8, !dbg !949
  %sum_of_squares_split_addr_5 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 5, !dbg !949 ; <double*> [#uses=2]
  store double 0.000000e+000, double* %sum_of_squares_split_addr_5, align 8, !dbg !949
  %sum_of_squares_split_addr_6 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 6, !dbg !949 ; <double*> [#uses=2]
  store double 0.000000e+000, double* %sum_of_squares_split_addr_6, align 8, !dbg !949
  %sum_of_squares_split_addr_7 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 7, !dbg !949 ; <double*> [#uses=2]
  store double 0.000000e+000, double* %sum_of_squares_split_addr_7, align 8, !dbg !949
  br label %bb1, !dbg !950

bb:                                               ; preds = %bb1
  %dim_cast2 = trunc i8 %dim to i3                ; <i3> [#uses=1]
  call void @llvm.dbg.value(metadata !{i8 %dim}, i64 0, metadata !951)
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str34) nounwind, !dbg !953
  %tmp_s = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str34) nounwind, !dbg !953 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str16) nounwind, !dbg !955
  %vector1_data_V_read = call i64 @_ssdm_op_FifoRead.volatile.i64P(i64* %vector1_data_V) nounwind, !dbg !956 ; <i64> [#uses=1]
  %vector1_data = sitofp i64 %vector1_data_V_read to double, !dbg !957 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %vector1_data}, i64 0, metadata !958), !dbg !957
  %vector2_data_V_read = call i64 @_ssdm_op_FifoRead.volatile.i64P(i64* %vector2_data_V) nounwind, !dbg !959 ; <i64> [#uses=1]
  %vector2_data = sitofp i64 %vector2_data_V_read to double, !dbg !960 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %vector2_data}, i64 0, metadata !961), !dbg !960
  %diff = fsub double %vector1_data, %vector2_data, !dbg !962 ; <double> [#uses=2]
  call void @llvm.dbg.value(metadata !{double %diff}, i64 0, metadata !963), !dbg !962
  %diff_squared = fmul double %diff, %diff, !dbg !964 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %diff_squared}, i64 0, metadata !965), !dbg !964
  %tmp_cast = zext i3 %dim_cast2 to i32, !dbg !966 ; <i32> [#uses=1]
  %sum_of_squares_split_addr_8 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i32 0, i32 %tmp_cast, !dbg !966 ; <double*> [#uses=2]
  %sum_of_squares_split_load = load double* %sum_of_squares_split_addr_8, align 8, !dbg !966 ; <double> [#uses=1]
  %tmp_1 = fadd double %sum_of_squares_split_load, %diff_squared, !dbg !966 ; <double> [#uses=1]
  store double %tmp_1, double* %sum_of_squares_split_addr_8, align 8, !dbg !966
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str34, i32 %tmp_s) nounwind, !dbg !967 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i8 %dim_1}, i64 0, metadata !951), !dbg !950
  br label %bb1, !dbg !950

bb1:                                              ; preds = %bb, %entry
  %dim = phi i8 [ %dim_1, %bb ], [ 0, %entry ]    ; <i8> [#uses=3]
  %exitcond1 = icmp eq i8 %dim, -56, !dbg !950    ; <i1> [#uses=1]
  %dim_1 = add i8 %dim, 1, !dbg !950              ; <i8> [#uses=1]
...
bb4.0:                                            ; preds = %bb1
  ...
  %sum_of_squares_split_load_1 = load double* %sum_of_squares_split_addr, align 8, !dbg !970 ; <double> [#uses=2]
  %sum_of_squares_1_0_to_fcmp = fcmp oeq double %sum_of_squares_split_load_1, -0.000000e+000, !dbg !970 ; <i1> [#uses=1]
  %sum_of_squares = select i1 %sum_of_squares_1_0_to_fcmp, double 0.000000e+000, double %sum_of_squares_split_load_1, !dbg !970 ; <double> [#uses=1]
  ...
  %sum_of_squares_split_load_2 = load double* %sum_of_squares_split_addr_1, align 8, !dbg !970 ; <double> [#uses=1]
  %sum_of_squares_1 = fadd double %sum_of_squares_split_load_2, %sum_of_squares, !dbg !970 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_1}, i64 0, metadata !968), !dbg !970
  call void @llvm.dbg.value(metadata !{i32 2}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_1}, i64 0, metadata !968)
  call void @llvm.dbg.value(metadata !{i32 2}, i64 0, metadata !969)
  %sum_of_squares_split_load_3 = load double* %sum_of_squares_split_addr_2, align 8, !dbg !970 ; <double> [#uses=1]
  %sum_of_squares_2 = fadd double %sum_of_squares_split_load_3, %sum_of_squares_1, !dbg !970 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_2}, i64 0, metadata !968), !dbg !970
  call void @llvm.dbg.value(metadata !{i32 3}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_2}, i64 0, metadata !968)
  call void @llvm.dbg.value(metadata !{i32 3}, i64 0, metadata !969)
  %sum_of_squares_split_load_4 = load double* %sum_of_squares_split_addr_3, align 8, !dbg !970 ; <double> [#uses=1]
  %sum_of_squares_3 = fadd double %sum_of_squares_split_load_4, %sum_of_squares_2, !dbg !970 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_3}, i64 0, metadata !968), !dbg !970
  call void @llvm.dbg.value(metadata !{i32 4}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_3}, i64 0, metadata !968)
  call void @llvm.dbg.value(metadata !{i32 4}, i64 0, metadata !969)
  %sum_of_squares_split_load_5 = load double* %sum_of_squares_split_addr_4, align 8, !dbg !970 ; <double> [#uses=1]
  %sum_of_squares_4 = fadd double %sum_of_squares_split_load_5, %sum_of_squares_3, !dbg !970 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_4}, i64 0, metadata !968), !dbg !970
  call void @llvm.dbg.value(metadata !{i32 5}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_4}, i64 0, metadata !968)
  call void @llvm.dbg.value(metadata !{i32 5}, i64 0, metadata !969)
  %sum_of_squares_split_load_6 = load double* %sum_of_squares_split_addr_5, align 8, !dbg !970 ; <double> [#uses=1]
  %sum_of_squares_5 = fadd double %sum_of_squares_split_load_6, %sum_of_squares_4, !dbg !970 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_5}, i64 0, metadata !968), !dbg !970
  call void @llvm.dbg.value(metadata !{i32 6}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_5}, i64 0, metadata !968)
  call void @llvm.dbg.value(metadata !{i32 6}, i64 0, metadata !969)
  %sum_of_squares_split_load_7 = load double* %sum_of_squares_split_addr_6, align 8, !dbg !970 ; <double> [#uses=1]
  %sum_of_squares_6 = fadd double %sum_of_squares_split_load_7, %sum_of_squares_5, !dbg !970 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_6}, i64 0, metadata !968), !dbg !970
  call void @llvm.dbg.value(metadata !{i32 7}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_6}, i64 0, metadata !968)
  call void @llvm.dbg.value(metadata !{i32 7}, i64 0, metadata !969)
  %sum_of_squares_split_load_8 = load double* %sum_of_squares_split_addr_7, align 8, !dbg !970 ; <double> [#uses=1]
  %sum_of_squares_7 = fadd double %sum_of_squares_split_load_8, %sum_of_squares_6, !dbg !970 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_7}, i64 0, metadata !968), !dbg !970
  call void @llvm.dbg.value(metadata !{i32 8}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_7}, i64 0, metadata !968)
  call void @llvm.dbg.value(metadata !{i32 8}, i64 0, metadata !969)
  call void @_ssdm_op_WireWrite.doubleP(double* %sum, double %sum_of_squares_7) nounwind, !dbg !972
  ret void, !dbg !973
}
...
!6 = metadata !{i32 462851, metadata !7, metadata !"vector1.data.V", metadata !2, i32 59, metadata !893} ; [ DW_TAG_arg_variable_field ]
...
!906 = metadata !{i32 462851, metadata !7, metadata !"vector1.keep.V", metadata !2, i32 59, metadata !907} ; [ DW_TAG_arg_variable_field ]
...
!918 = metadata !{i32 462851, metadata !7, metadata !"vector1.last.V", metadata !2, i32 59, metadata !919} ; [ DW_TAG_arg_variable_field ]
...
!930 = metadata !{i32 462851, metadata !931, metadata !"vector2.data.V", metadata !2, i32 59, metadata !893} ; [ DW_TAG_arg_variable_field ]
!931 = metadata !{i32 459009, metadata !8, metadata !"vector2", metadata !2, i32 59, metadata !11} ; [ DW_TAG_arg_variable ]
!932 = metadata !{i32 462851, metadata !931, metadata !"vector2.keep.V", metadata !2, i32 59, metadata !907} ; [ DW_TAG_arg_variable_field ]
!933 = metadata !{i32 462851, metadata !931, metadata !"vector2.last.V", metadata !2, i32 59, metadata !919} ; [ DW_TAG_arg_variable_field ]
!934 = metadata !{i32 459009, metadata !8, metadata !"sum", metadata !2, i32 59, metadata !935} ; [ DW_TAG_arg_variable ]
!935 = metadata !{i32 458790, metadata !1, metadata !"", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !891} ; [ DW_TAG_const_type ]
!936 = metadata !{i32 459008, metadata !937, metadata !"sum_of_squares__split", metadata !2, i32 85, metadata !939} ; [ DW_TAG_auto_variable ]
!937 = metadata !{i32 458763, metadata !938, i32 59, i32 0} ; [ DW_TAG_lexical_block ]
!938 = metadata !{i32 458763, metadata !8, i32 59, i32 0} ; [ DW_TAG_lexical_block ]
...
!942 = metadata !{i32 59, i32 0, metadata !937, null}
!943 = metadata !{i32 61, i32 0, metadata !937, null}
!944 = metadata !{i32 64, i32 0, metadata !937, null}
!945 = metadata !{i32 67, i32 0, metadata !937, null}
!946 = metadata !{i32 70, i32 0, metadata !937, null}
!947 = metadata !{i32 73, i32 0, metadata !937, null}
!948 = metadata !{i32 74, i32 0, metadata !937, null}
!949 = metadata !{i32 85, i32 0, metadata !937, null}
!950 = metadata !{i32 88, i32 0, metadata !937, null}
!951 = metadata !{i32 459008, metadata !937, metadata !"dim", metadata !2, i32 87, metadata !952} ; [ DW_TAG_auto_variable ]
!952 = metadata !{i32 458774, metadata !1, metadata !"uint_t", metadata !13, i32 133, i64 0, i64 0, i64 0, i32 0, metadata !5} ; [ DW_TAG_typedef ]
!953 = metadata !{i32 88, i32 0, metadata !954, null}
!954 = metadata !{i32 458763, metadata !937, i32 88, i32 0} ; [ DW_TAG_lexical_block ]
!955 = metadata !{i32 90, i32 0, metadata !954, null}
!956 = metadata !{i32 1282, i32 0, metadata !41, metadata !957}
!957 = metadata !{i32 96, i32 0, metadata !954, null}
!958 = metadata !{i32 459008, metadata !954, metadata !"vector1_data", metadata !2, i32 96, metadata !892} ; [ DW_TAG_auto_variable ]
!959 = metadata !{i32 1282, i32 0, metadata !41, metadata !960}
!960 = metadata !{i32 97, i32 0, metadata !954, null}
!961 = metadata !{i32 459008, metadata !954, metadata !"vector2_data", metadata !2, i32 97, metadata !892} ; [ DW_TAG_auto_variable ]
!962 = metadata !{i32 99, i32 0, metadata !954, null}
!963 = metadata !{i32 459008, metadata !954, metadata !"diff", metadata !2, i32 99, metadata !892} ; [ DW_TAG_auto_variable ]
!964 = metadata !{i32 100, i32 0, metadata !954, null}
!965 = metadata !{i32 459008, metadata !954, metadata !"diff_squared", metadata !2, i32 100, metadata !892} ; [ DW_TAG_auto_variable ]
!966 = metadata !{i32 101, i32 0, metadata !954, null}
!967 = metadata !{i32 102, i32 0, metadata !954, null}
!968 = metadata !{i32 459008, metadata !937, metadata !"sum_of_squares", metadata !2, i32 104, metadata !892} ; [ DW_TAG_auto_variable ]
!969 = metadata !{i32 459008, metadata !937, metadata !"i", metadata !2, i32 105, metadata !952} ; [ DW_TAG_auto_variable ]
!970 = metadata !{i32 110, i32 0, metadata !937, null}
!971 = metadata !{i32 106, i32 0, metadata !937, null}
!972 = metadata !{i32 113, i32 0, metadata !937, null}
!973 = metadata !{i32 114, i32 0, metadata !937, null}
