; ModuleID = '/home/joshua/Documents/University/Thesis/Code/TopN_Outlier_Pruning_Block/AutoESL/NO_BLOCKING/solution1/.autopilot/db/a.o.3.bc'
...
entry:
  ...
  call void @llvm.dbg.value(metadata !{i64* %vector1_data_V}, i64 0, metadata !6)
  call void @llvm.dbg.value(metadata !{i8* %vector1_keep_V}, i64 0, metadata !907)
  call void @llvm.dbg.value(metadata !{i1* %vector1_last_V}, i64 0, metadata !919)
  call void @llvm.dbg.value(metadata !{i64* %vector2_data_V}, i64 0, metadata !931)
  call void @llvm.dbg.value(metadata !{i8* %vector2_keep_V}, i64 0, metadata !933)
  call void @llvm.dbg.value(metadata !{i1* %vector2_last_V}, i64 0, metadata !934)
  call void @llvm.dbg.value(metadata !{double* %sum}, i64 0, metadata !935)
  call void @llvm.dbg.declare(metadata !{[8 x double]* %sum_of_squares_split}, metadata !937), !dbg !943
  call void (...)* @_ssdm_op_SpecWire(i32 0, [11 x i8]* @p_str7, [1 x i8]* @p_str8) nounwind, !dbg !944
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str9) nounwind, !dbg !945 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecWire(double* %sum, [8 x i8]* @p_str10, [1 x i8]* @p_str8) nounwind, !dbg !945
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str9, i32 %tmp) nounwind, !dbg !945 ; <i32> [#uses=0]
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str11) nounwind, !dbg !946 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @p_str8, [10 x i8]* @p_str12, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [66 x i8]* @p_str13, [24 x i8]* @p_str14) nounwind, !dbg !946
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str11, i32 %tmp_4) nounwind, !dbg !946 ; <i32> [#uses=0]
  %tmp_5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str15) nounwind, !dbg !947 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecIFCore(double* %sum, [1 x i8]* @p_str8, [10 x i8]* @p_str12, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [24 x i8]* @p_str14) nounwind, !dbg !947
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str15, i32 %tmp_5) nounwind, !dbg !947 ; <i32> [#uses=0]
  %tmp_6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str16) nounwind, !dbg !948 ; <i32> [#uses=1]
  %tmp_7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str17) nounwind, !dbg !948 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecFifo(i64* %vector1_data_V, i8* %vector1_keep_V, i1* %vector1_last_V, [8 x i8]* @p_str18, [1 x i8]* @p_str8), !dbg !948
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str17, i32 %tmp_7) nounwind, !dbg !948 ; <i32> [#uses=0]
  call void (...)* @_ssdm_op_SpecIFCore(i64* %vector1_data_V, i8* %vector1_keep_V, i1* %vector1_last_V, [1 x i8]* @p_str8, [5 x i8]* @p_str19, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [27 x i8]* @p_str20) nounwind, !dbg !948
  call void (...)* @_ssdm_op_SpecIFCore(i64* %vector1_data_V, i8* %vector1_keep_V, i1* %vector1_last_V, [1 x i8]* @p_str8, [5 x i8]* @p_str19, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [139 x i8]* @p_str21, [1 x i8]* @p_str8) nounwind, !dbg !948
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str16, i32 %tmp_6) nounwind, !dbg !948 ; <i32> [#uses=0]
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str22) nounwind, !dbg !949 ; <i32> [#uses=1]
  %tmp_9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str23) nounwind, !dbg !949 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecFifo(i64* %vector2_data_V, i8* %vector2_keep_V, i1* %vector2_last_V, [8 x i8]* @p_str18, [1 x i8]* @p_str8), !dbg !949
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str23, i32 %tmp_9) nounwind, !dbg !949 ; <i32> [#uses=0]
  call void (...)* @_ssdm_op_SpecIFCore(i64* %vector2_data_V, i8* %vector2_keep_V, i1* %vector2_last_V, [1 x i8]* @p_str8, [5 x i8]* @p_str19, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [27 x i8]* @p_str24) nounwind, !dbg !949
  call void (...)* @_ssdm_op_SpecIFCore(i64* %vector2_data_V, i8* %vector2_keep_V, i1* %vector2_last_V, [1 x i8]* @p_str8, [5 x i8]* @p_str19, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [139 x i8]* @p_str25, [1 x i8]* @p_str8) nounwind, !dbg !949
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str22, i32 %tmp_8) nounwind, !dbg !949 ; <i32> [#uses=0]
  %sum_of_squares_split_addr = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 0, !dbg !950 ; <double*> [#uses=2]
  store double 0.000000e+00, double* %sum_of_squares_split_addr, align 8, !dbg !950
  %sum_of_squares_split_addr_1 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 1, !dbg !950 ; <double*> [#uses=2]
  store double 0.000000e+00, double* %sum_of_squares_split_addr_1, align 8, !dbg !950
  %sum_of_squares_split_addr_2 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 2, !dbg !950 ; <double*> [#uses=2]
  store double 0.000000e+00, double* %sum_of_squares_split_addr_2, align 8, !dbg !950
  %sum_of_squares_split_addr_3 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 3, !dbg !950 ; <double*> [#uses=2]
  store double 0.000000e+00, double* %sum_of_squares_split_addr_3, align 8, !dbg !950
  %sum_of_squares_split_addr_4 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 4, !dbg !950 ; <double*> [#uses=2]
  store double 0.000000e+00, double* %sum_of_squares_split_addr_4, align 8, !dbg !950
  %sum_of_squares_split_addr_5 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 5, !dbg !950 ; <double*> [#uses=2]
  store double 0.000000e+00, double* %sum_of_squares_split_addr_5, align 8, !dbg !950
  %sum_of_squares_split_addr_6 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 6, !dbg !950 ; <double*> [#uses=2]
  store double 0.000000e+00, double* %sum_of_squares_split_addr_6, align 8, !dbg !950
  %sum_of_squares_split_addr_7 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 7, !dbg !950 ; <double*> [#uses=2]
  store double 0.000000e+00, double* %sum_of_squares_split_addr_7, align 8, !dbg !950
  br label %bb1, !dbg !951

bb:                                               ; preds = %bb1
  %dim_cast2 = trunc i8 %dim to i3                ; <i3> [#uses=1]
  call void @llvm.dbg.value(metadata !{i8 %dim}, i64 0, metadata !952)
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str26) nounwind, !dbg !954
  %tmp_s = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str26) nounwind, !dbg !954 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str8) nounwind, !dbg !956
  %vector1_data_V_read = call i64 @_ssdm_op_FifoRead.volatile.i64P(i64* %vector1_data_V) nounwind, !dbg !957 ; <i64> [#uses=1]
  %vector1_data = sitofp i64 %vector1_data_V_read to double, !dbg !958 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %vector1_data}, i64 0, metadata !959), !dbg !958
  %vector2_data_V_read = call i64 @_ssdm_op_FifoRead.volatile.i64P(i64* %vector2_data_V) nounwind, !dbg !960 ; <i64> [#uses=1]
  %vector2_data = sitofp i64 %vector2_data_V_read to double, !dbg !961 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %vector2_data}, i64 0, metadata !962), !dbg !961
  %diff = fsub double %vector1_data, %vector2_data, !dbg !963 ; <double> [#uses=2]
  call void @llvm.dbg.value(metadata !{double %diff}, i64 0, metadata !964), !dbg !963
  %diff_squared = fmul double %diff, %diff, !dbg !965 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %diff_squared}, i64 0, metadata !966), !dbg !965
  %tmp_2 = zext i3 %dim_cast2 to i64, !dbg !967   ; <i64> [#uses=1]
  %sum_of_squares_split_addr_8 = getelementptr inbounds [8 x double]* %sum_of_squares_split, i64 0, i64 %tmp_2, !dbg !967 ; <double*> [#uses=2]
  %sum_of_squares_split_load = load double* %sum_of_squares_split_addr_8, align 8, !dbg !967 ; <double> [#uses=1]
  %tmp_3 = fadd double %sum_of_squares_split_load, %diff_squared, !dbg !967 ; <double> [#uses=1]
  store double %tmp_3, double* %sum_of_squares_split_addr_8, align 8, !dbg !967
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str26, i32 %tmp_s) nounwind, !dbg !968 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i8 %dim_1}, i64 0, metadata !952), !dbg !951
  br label %bb1, !dbg !951

bb1:                                              ; preds = %bb, %entry
  %dim = phi i8 [ %dim_1, %bb ], [ 0, %entry ]    ; <i8> [#uses=3]
  %exitcond1 = icmp eq i8 %dim, -56, !dbg !951    ; <i1> [#uses=1]
  %dim_1 = add i8 %dim, 1, !dbg !951              ; <i8> [#uses=1]
...
bb4.0:                                            ; preds = %bb1
  ...
  %sum_of_squares_split_load_1 = load double* %sum_of_squares_split_addr, align 8, !dbg !971 ; <double> [#uses=2]
  %sum_of_squares_1_0_to_fcmp = fcmp oeq double %sum_of_squares_split_load_1, -0.000000e+00, !dbg !971 ; <i1> [#uses=1]
  %sum_of_squares = select i1 %sum_of_squares_1_0_to_fcmp, double 0.000000e+00, double %sum_of_squares_split_load_1, !dbg !971 ; <double> [#uses=1]
  ...
  %sum_of_squares_split_load_2 = load double* %sum_of_squares_split_addr_1, align 8, !dbg !971 ; <double> [#uses=1]
  %sum_of_squares_1 = fadd double %sum_of_squares_split_load_2, %sum_of_squares, !dbg !971 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_1}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{i32 2}, i64 0, metadata !970), !dbg !972
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_1}, i64 0, metadata !969)
  call void @llvm.dbg.value(metadata !{i32 2}, i64 0, metadata !970)
  %sum_of_squares_split_load_3 = load double* %sum_of_squares_split_addr_2, align 8, !dbg !971 ; <double> [#uses=1]
  %sum_of_squares_2 = fadd double %sum_of_squares_split_load_3, %sum_of_squares_1, !dbg !971 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_2}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{i32 3}, i64 0, metadata !970), !dbg !972
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_2}, i64 0, metadata !969)
  call void @llvm.dbg.value(metadata !{i32 3}, i64 0, metadata !970)
  %sum_of_squares_split_load_4 = load double* %sum_of_squares_split_addr_3, align 8, !dbg !971 ; <double> [#uses=1]
  %sum_of_squares_3 = fadd double %sum_of_squares_split_load_4, %sum_of_squares_2, !dbg !971 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_3}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{i32 4}, i64 0, metadata !970), !dbg !972
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_3}, i64 0, metadata !969)
  call void @llvm.dbg.value(metadata !{i32 4}, i64 0, metadata !970)
  %sum_of_squares_split_load_5 = load double* %sum_of_squares_split_addr_4, align 8, !dbg !971 ; <double> [#uses=1]
  %sum_of_squares_4 = fadd double %sum_of_squares_split_load_5, %sum_of_squares_3, !dbg !971 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_4}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{i32 5}, i64 0, metadata !970), !dbg !972
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_4}, i64 0, metadata !969)
  call void @llvm.dbg.value(metadata !{i32 5}, i64 0, metadata !970)
  %sum_of_squares_split_load_6 = load double* %sum_of_squares_split_addr_5, align 8, !dbg !971 ; <double> [#uses=1]
  %sum_of_squares_5 = fadd double %sum_of_squares_split_load_6, %sum_of_squares_4, !dbg !971 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_5}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{i32 6}, i64 0, metadata !970), !dbg !972
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_5}, i64 0, metadata !969)
  call void @llvm.dbg.value(metadata !{i32 6}, i64 0, metadata !970)
  %sum_of_squares_split_load_7 = load double* %sum_of_squares_split_addr_6, align 8, !dbg !971 ; <double> [#uses=1]
  %sum_of_squares_6 = fadd double %sum_of_squares_split_load_7, %sum_of_squares_5, !dbg !971 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_6}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{i32 7}, i64 0, metadata !970), !dbg !972
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_6}, i64 0, metadata !969)
  call void @llvm.dbg.value(metadata !{i32 7}, i64 0, metadata !970)
  %sum_of_squares_split_load_8 = load double* %sum_of_squares_split_addr_7, align 8, !dbg !971 ; <double> [#uses=1]
  %sum_of_squares_7 = fadd double %sum_of_squares_split_load_8, %sum_of_squares_6, !dbg !971 ; <double> [#uses=1]
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_7}, i64 0, metadata !969), !dbg !971
  call void @llvm.dbg.value(metadata !{i32 8}, i64 0, metadata !970), !dbg !972
  call void @llvm.dbg.value(metadata !{double %sum_of_squares_7}, i64 0, metadata !969)
  call void @llvm.dbg.value(metadata !{i32 8}, i64 0, metadata !970)
  call void @_ssdm_op_WireWrite.doubleP(double* %sum, double %sum_of_squares_7) nounwind, !dbg !973
  ret void, !dbg !974
}
...
!952 = metadata !{i32 459008, metadata !938, metadata !"dim", metadata !2, i32 87, metadata !953} ; [ DW_TAG_auto_variable ]
!953 = metadata !{i32 458774, metadata !1, metadata !"uint_t", metadata !13, i32 133, i64 0, i64 0, i64 0, i32 0, metadata !79} ; [ DW_TAG_typedef ]
!954 = metadata !{i32 88, i32 0, metadata !955, null}
!955 = metadata !{i32 458763, metadata !938, i32 88, i32 0} ; [ DW_TAG_lexical_block ]
!956 = metadata !{i32 90, i32 0, metadata !955, null}
!957 = metadata !{i32 1282, i32 0, metadata !41, metadata !958}
!958 = metadata !{i32 96, i32 0, metadata !955, null}
!959 = metadata !{i32 459008, metadata !955, metadata !"vector1_data", metadata !2, i32 96, metadata !892} ; [ DW_TAG_auto_variable ]
!960 = metadata !{i32 1282, i32 0, metadata !41, metadata !961}
!961 = metadata !{i32 97, i32 0, metadata !955, null}
!962 = metadata !{i32 459008, metadata !955, metadata !"vector2_data", metadata !2, i32 97, metadata !892} ; [ DW_TAG_auto_variable ]
!963 = metadata !{i32 99, i32 0, metadata !955, null}
!964 = metadata !{i32 459008, metadata !955, metadata !"diff", metadata !2, i32 99, metadata !892} ; [ DW_TAG_auto_variable ]
!965 = metadata !{i32 100, i32 0, metadata !955, null}
!966 = metadata !{i32 459008, metadata !955, metadata !"diff_squared", metadata !2, i32 100, metadata !892} ; [ DW_TAG_auto_variable ]
!967 = metadata !{i32 101, i32 0, metadata !955, null}
!968 = metadata !{i32 102, i32 0, metadata !955, null}
!969 = metadata !{i32 459008, metadata !938, metadata !"sum_of_squares", metadata !2, i32 104, metadata !892} ; [ DW_TAG_auto_variable ]
!970 = metadata !{i32 459008, metadata !938, metadata !"i", metadata !2, i32 105, metadata !953} ; [ DW_TAG_auto_variable ]
