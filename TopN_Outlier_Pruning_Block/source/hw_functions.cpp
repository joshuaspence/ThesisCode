...
/* Includes                                                                   */
/*============================================================================*/
#include "hw_functions.h" /* main include file */
...
static void set_outer_vector_hw(const double vector[VECTOR_DIMS]) {
    unsigned int dim;
...
static double distance_squared_hw(const double inner_vector[VECTOR_DIMS]) {
...
unsigned int top_n_outlier_pruning_block_hw(
    ...
    return top_n_outlier_pruning_block(_num_vectors, _vector_dims, _data,
            ...
            set_outer_vector_hw, distance_squared_hw);
}