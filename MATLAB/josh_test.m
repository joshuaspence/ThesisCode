...
base_profile = struct('name', 'original',  'func', 'TopN_Outlier_Pruning_Block_MATLAB_ORIGINAL');
profiles = [
	% MATLAB
    %struct('name', 'original_inline',  'func', 'TopN_Outlier_Pruning_Block_MATLAB_ORIGINAL_INLINE'), ...
    %struct('name', 'sorted',           'func', 'TopN_Outlier_Pruning_Block_MATLAB_IMPROVED'), ...
    %struct('name', 'sorted_inline',    'func', 'TopN_Outlier_Pruning_Block_MATLAB_IMPROVED_INLINE'), ...
