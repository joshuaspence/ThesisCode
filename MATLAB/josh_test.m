...
profiles = [
    ...
    struct('name', 'matlab_sorted',           'func', 'TopN_Outlier_Pruning_Block_MATLAB_IMPROVED'), ...
    struct('name', 'matlab_sorted_inline',    'func', 'TopN_Outlier_Pruning_Block_MATLAB_IMPROVED_INLINE'), ...
    ...
    struct('name', 'C_sorted_no_blocking',    'func', 'TopN_Outlier_Pruning_Block_C_SORTED_NO_BLOCKING'), ...
];
